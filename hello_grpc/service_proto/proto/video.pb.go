...
var file_video_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x32, 0x39, 0x0a, 0x0c, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x29, 0x0a, 0x04, 0x4c, 0x6f, 0x6f, 0x6b, 0x12, 0x0e, 0x2e, 0x70, 0x72, 0x6f,
...
var file_video_proto_depIdxs = []int32{
	0, // 0: proto.VideoService.Look:input_type -> proto.Request
	1, // 1: proto.VideoService.Look:output_type -> proto.Response
...
func (c *videoServiceClient) Look(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.VideoService/Look", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _VideoService_Look_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.VideoService/Look",
	}
